...
export const addRoomService = async (room) => {
    try {
        const result = await poolRequest()
            ...
            .query("INSERT INTO tbl_room (RoomID, RoomName, RoomNumber, description, RoomCategory, CreatedAt) VALUES (@RoomID, @RoomName, @RoomNumber, @description, @RoomCategory, @CreatedAt)");
        return result;
    } catch (error) {
        return error;
    }
